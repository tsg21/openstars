...
of Automatic. The default chooses the optimum speed (attempting a speed that uses the least amount of fuel to intercept in the shortest possible time). You will be notified when a patrolling fleet is given a new target and can adjust the warp speed or retarget it before the intercept happens.
...
and then give it the Patrol task and select the Repeat Orders checkbox in the Fleet Waypoints tile.
