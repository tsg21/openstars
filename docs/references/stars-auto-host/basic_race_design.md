...
> **Rule of thumb:** You should playtest your race at least once before going head to head with real human beings. Unseen pitfalls can become quite apparent in the first few years of a testbed.
...
This trait is the delight of the sneaky minded. Races with Super Stealth excel at cloaking, and have two scanners (PickPocket and Robber Baron) that can steal minerals from other players. Lastly, they get a small spying bonus from all other players in the game, making technology fairly easy to attain. If you like to sneak around the universe causing trouble, this is the primary trait for you.
...
Races with this trait can gate ships like no one else. They start the game with stargates, and eventually can gate any ship, no matter how big, to any distance. This makes it easy to respond lightning fast to any threat or opportunity. Only these races can send minerals and colonists through their gates, making balancing of resources easy and quick. You might choose this trait only after you've played races based on other traits, realise that you want to make stargates a primary component in your Whole Game Strategy, and are continually frustrated with your inability to gate huge battle fleets and resources.
...
*Fig 2.1 — Improved Fuel Efficiency with the Fuel Mizer*
...
*Fig 2.2 — No Ram Scoops? So what? You get the Interspace 10 instead.*
...
*Fig 2.3 — The lowest level of Total Terraforming technology (3%) is free with the Total Terraforming trait. The highest level (shown here) requires Biotech level 25.*
...
> **Note:** Research costs are set on page 6 of the Custom Race Wizard. Research in Biotech also gives you access to the various "smart bombs" in Stars!.
...
*Fig 2.4 — The high powered, cheap to build Robo-Ultra Miner is available only to races with the Advanced Remote Mining trait.*

This trait is a good choice for those races looking to gain a large fraction of their minerals from planets that they do *not* inhabit. They get very nice, small, affordable ship hulls and mining robots at the beginning of the game. Later on, a single mining ship will be able to pull a disgusting (to other players) amount of minerals from an uninhabited planet. Also, the mining robots available to races with Advanced Remote Mining are generally cheaper and far more effective than mining robots built by other races.
...
*Fig 2.5 — It's the Robo-Mini-Miner for races that choose Only Basic Remote Mining (and who do not choose Advanced Remote Mining).*
...
> **Note:** The No Advanced Scanners trait has no effect on advantages provided by your primary racial trait.

The lack of penetrating scanners can hurt races that intend to be involved in planetary battles, since they will lose the ability to see fleets in orbit without having one of their own fleets present. If you do not have penetrating scanners, other races have a better chance of colonising worlds within your empire (perhaps next to your homeworld!) where you do not have a scout on lookout.

### Generalised Research

This choice favours those races that intend to do research in all fields, including the often-neglected Biotechnology. This choice will apply half of your annual research budget to the field of your choice, and 15% of the remaining budget to each of the remaining 5 fields (yes, this adds to 125%, giving you a research boost). However, if you are attempting to concentrate on a single field at the moment, it will take twice as long to achieve a given level in that one field. In addition, if any of your research categories reach maximum, the research allocated to them will be wasted.

> **Note:** Generalised Research gives you 125% of the research budget you would normally have available, providing a research boost along with the research distribution.
...
Therefore, this trait favours those races that intend to perform a great amount of research, or those who prefer the volume approach to building large numbers of older technology ships. This trait can hurt you in the endgame, as anything that is of technology level 26 (the maximum level) will *always* cost twice as much as it does for everybody else.
...
> **Note:** The Regenerating Shields trait has no effect on the *base* armor of hulls, only on the value of armor components. The base value is shown in the Ship Designer. The component value is shown in the Technology Browser.
...
While the Lesser Traits lend you personality, they still are not enough to significantly distinguish your race from others. There's still habitability and growth rate, resource utilisation, and research costs to fiddle with.

### Specify Habitability
...
For each of the three habitability factors, the coloured band represents the range of values that your race can tolerate, and still survive. The wider the coloured band is, the greater will be the number of planets that have a value for that factor which falls within your range. The narrower the range, the less likely it will be that any particular planet will have that value fall within that range.

*Fig 2.6 — This example shows environmental settings for a race that is limited to planets with a high radiation level. It is unaffected by gravity, and can survive at any temperature.*

As you explore, seek out planets with values closest to the *centre* of the coloured band: these represent the ideal conditions for your race. Values that are deep within the band you choose will give the planet in question a much higher *habitability percentage*, making the planet more valuable to your race. You can also slide the bands away from centre. This can reduce your competition with other races for the same "ideal" worlds.

> **Homeworld values:** Your homeworld is an example of the optimal world for your race.

Where you move the bar affects your effectiveness at terraforming. If you move the bar closer than 15 mouse clicks to a side, you will cut your Terraforming ability for that environmental factor a little. 10 clicks away is fine, while five is probably too close. Conversely, moving the bar more than 15 clicks is a waste of Advantage points (unless the ranges are very wide or you have Total Terraforming), as the farther from the centre you are, the more points you get back.
...
Moving to page 5 in the wizard, you see many interrelated controls that affect how efficient your population is at creating resources and running factories and mines. These controls all have an inter-related effect on the eventual resource and mineral output of your race. As you tune these settings, also keep in mind how fast your race will grow and how many planets your race will probably be able to inhabit.
...
Let's look at some example settings, and see how long it would take for one factory to produce an additional factory. This is a good indicator of how quickly a colony will be a viable resource for your empire.

With the default settings, 10 factories produce 10 resources per year. That gives you one resource per factory. Since new factories will cost 10 resources, it will take ten years for a factory to produce a copy of itself, based purely on its own production.
...
Electronics governs your scanners, jammers, and computers. It also affects which of the LBU bomb components are available. For races based on the Jack of All Trades trait, every gain in Electronics technology increases the scanner range, so they may want to make this field cheap.
...
By making careful choices on the Research page, you can add a distinctive flavour to the race you are designing, and perhaps get back a few points (or a lot, if you elect to set all fields expensive).
...
For every 10 points left over, you get one defence. This has the same drawbacks as extra factories does, with the added downfall that in the early game you really don't need planetary defences that much. At most, all you could get is five, and if you have nine points or less, you get nothing.
...
The choices that tend to cost only a few points, are choices that are more stylistic, rather than ones that have a major effect on the playability of the race. Generalised Research, Bleeding Edge Technology, and Regenerating Shields are examples of stylistic choices.
...
- To go up to 11 resources per 10 factories, you lose 43 points. To go to 12 you only lose 40 points. To go up to 13 suddenly costs 62 points. 12 resources per factory is another breakpoint.
- To bring mines down to requiring 4 resources to build (a 20% reduction) costs a measly 23 points. Going down further to 3 resources (a 25% reduction) costs 22 points. To get down to 2 (a 33% reduction) costs 134 points. Mines cost 3 resources is a breakpoint.

---

*© 1998, Mare Crisium, LLC*
