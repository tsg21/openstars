...
- [ ] Review and reformat `18-reports.md`
- [ ] Review and reformat `19-diplomacy-and-trade.md`
- [ ] Review and reformat `20-designing-custom-races.md`
- [ ] Review and reformat `21-predefined-races.md`
- [ ] Review and reformat `22-alternate-reality-races.md`
- [ ] Review and reformat `23-the-guts-of-combat.md`
- [ ] Review and reformat `24-the-guts-of-cloaking.md`
- [ ] Review and reformat `25-the-guts-of-mass-drivers.md`
- [ ] Review and reformat `26-the-guts-of-minefields.md`
- [ ] Review and reformat `appendix-a-keyboard-shortcuts.md`
- [ ] Review and reformat `appendix-b-technology-tables.md`
- [ ] Review and reformat `appendix-c-files-used-in-stars.md`
- [ ] Review and reformat `appendix-d-frequently-asked-questions.md`
- [ ] Review and reformat `index.md`
