...
- ✅ Completed `appendix-b-technology-tables.md` by turning the OCR stub into a readable appendix reference, restoring the full table-category index from the manual contents page, and explicitly noting that the actual table bodies did not survive in the split Markdown extraction.
