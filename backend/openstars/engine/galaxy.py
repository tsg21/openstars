...
_PLANET_NAMES = [
    "Sol", "Alpha Centauri", "Sirius", "Vega", "Procyon", "Altair", "Rigel",
    "Betelgeuse", "Antares", "Aldebaran", "Polaris", "Deneb", "Canopus",
    "Arcturus", "Capella", "Fomalhaut", "Regulus", "Achernar", "Spica",
    "Bellatrix", "Castor", "Pollux", "Mira", "Rasalhague", "Albireo",
    "Mintaka", "Alnilam", "Alnitak", "Saiph", "Elnath", "Menkalinan",
    "Dubhe", "Merak", "Phecda", "Megrez", "Alioth", "Mizar", "Alkaid",
    "Thuban", "Eltanin", "Rastaban", "Kochab", "Pherkad", "Schedar",
    "Caph", "Ruchbah", "Segin", "Achird", "Almach", "Mirach", "Hamal",
    "Sheratan", "Mesarthim", "Bharani", "Botein", "Menkar", "Mira Ceti",
    "Cursa", "Rigel Kent", "Hadar", "Mimosa", "Gacrux", "Acrux",
    "Atria", "Peacock", "Alnair", "Ankaa", "Diphda", "Sadalmelik",
    "Sadalsuud", "Markab", "Scheat", "Algenib", "Enif", "Biham",
    "Sadachbia", "Nashira", "Skat", "Deneb Algedi", "Grumium", "Alderamin",
    "Errai", "Alfirk", "Kurhah", "Sadr", "Gienah", "Algorab",
    "Kraz", "Minkar", "Alchiba", "Cor Caroli", "Vindemiatrix", "Zaniah",
    "Porrima", "Auva", "Heze", "Zubenelgenubi", "Zubeneschamali",
    "Dschubba", "Acrab", "Yed Prior", "Yed Posterior", "Sabik",
    "Rasalgethi", "Kornephoros", "Marfik", "Cebalrai", "Unukalhai",
    "Alya", "Nunki", "Kaus Australis", "Kaus Media", "Kaus Borealis",
    "Ascella", "Albaldah", "Rukbat", "Dabih", "Algedi", "Giedi",
    "Sadalbaari", "Tarazed", "Alshain", "Tseen Ke", "Okab", "Wezen",
    "Adhara", "Furud", "Aludra", "Muliphein", "Naos", "Regor",
    "Suhail", "Markeb", "Avior", "Aspidiske", "Tureis", "Alsephina",
    "Miaplacidus", "Theta Carinae", "Eta Carinae", "Koo She",
    "Muscida", "Tania Borealis", "Tania Australis", "Talitha",
    "Alula Borealis", "Alula Australis", "Praecipua", "Tegmine",
    "Acubens", "Asellus Borealis", "Asellus Australis", "Alterf",
    "Subra", "Chertan", "Zosma", "Coxa", "Denebola",
    "Muphrid", "Izar", "Seginus", "Nekkar", "Merga",
    "Alphecca", "Gemma", "Nusakan",
    "Kitalpha", "Sarin", "Maasym",
    "Sheliak", "Sulafat", "Aladfar",
    "Rotanev", "Sualocin", "Musica",
    "Anser", "Sagitta",
    "Albali", "Sadalund", "Bunda",
    "Situla", "Sadaltager",
    "Alrescha", "Torcular", "Fumalsamakah", "Vernalis",
    "Revati", "Baten Kaitos", "Kaffaljidhma",
    "Azha", "Acamar", "Zaurak", "Rana",
    "Arneb", "Nihal", "Gomeisa",
    "Wasat", "Mebsuta", "Propus", "Tejat",
    "Alhena", "Mekbuda", "Alzirr",
    "Phact", "Wazn",
    "Ain", "Hyadum", "Chamukuy", "Prima Hyadum", "Secunda Hyadum",
    "Tianguan", "Nath", "Hassaleh", "Hoedus", "Saclateni",
]
