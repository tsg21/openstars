...
prt_cost: dict[PRT, int] = {
    PRT.HYPER_EXPANSION: 0,
    PRT.SUPER_STEALTH: 0,
    PRT.WAR_MONGER: 0,
    PRT.CLAIM_ADJUSTER: 0,
    PRT.INNER_STRENGTH: 0,
    PRT.SPACE_DEMOLITION: 0,
    PRT.PACKET_PHYSICS: 0,
    PRT.INTERSTELLAR_TRAVELLER: 0,
    PRT.ALTERNATE_REALITY: 0,
    PRT.JACK_OF_ALL_TRADES: 0,
}

lrt_cost: dict[LRT, int] = {lrt: 0 for lrt in LRT}
