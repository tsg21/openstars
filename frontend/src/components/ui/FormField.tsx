...
export function CompactInput({
  ...
  return (
    <input
      className={cn(
        "rounded border border-[var(--color-panel-border)] bg-black/30 px-1.5 py-0.5 text-xs text-foreground focus:border-[var(--color-player-self)] focus:outline-none disabled:opacity-50",
        className,
      )}
      {...props}
    />
